...
class ServerConnection(Connection):
    ...
    def regularize_iso2022jp_ext(self, in_data):
        jis_flag = 0
        skip = False
        copy_data = bytearray()
        for index in range(len(in_data)):
            if 0 == jis_flag:
                ...
                if in_data[index] == 0x28:
                    jis_flag = 2
                elif in_data[index] == 0x42:
                    jis_flag = 0
                else:
                    jis_flag = 0
            elif 2 == jis_flag:
                if in_data[index] == 0x4a:
                    copy_data.append(0x49)
                    jis_flag = 3
                    skip = True
                elif in_data[index] == 0x28:
                    jis_flag = 1
                else:
                    jis_flag = 0
            elif 3 == jis_flag:
            ...
            if skip is False:
                if 3 == jis_flag:
                    copy_data.append(in_data[index] & 0x7f)
                else:
